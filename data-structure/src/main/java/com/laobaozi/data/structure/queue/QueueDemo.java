package com.laobaozi.data.structure.queue;
...
public class QueueDemo {
    ...
    public static void main(String[] args) {
         ...
         * 但是如果队列为空，那么取元素的操作take就会阻塞，所以它的检索操作take是受阻的。另外，往入该队列中的元
         * 素要具有比较能力。
         */
         ...
         * 当一个元素的 getDelay(TimeUnit.NANOSECONDS) 方法返回一个小于或等于零的值时，则出现期满，
         * poll就以移除这个元素了。此队列不允许使用 null 元素。
         */
